namespace ClassLibrary.Tests
{
    ...
    public class DALTests
    {
        ...
        public void GetOrdersTest()
        {
            ...
            enumOrderState expectedStateOrder = enumOrderState.Executed;

            // act
            orders = dal.GetOrders(1, 2);
            ...
            Assert.AreEqual(expectedStateOrder, orders[0].OrderState);
        }
        ...
        public void GetInfoOrderTest()
        {
            ...
            // act
            var order = dal.GetInfoOrder(orderID);

            // arrange
            Assert.AreEqual(expectedOrderID, order.OrderID);
            Assert.AreEqual(expectedShippedDate, order.ShippedDate);
            Assert.AreEqual(expectedOrderDate, order.OrderDate);
        }
